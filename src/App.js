...
return (
    ...
    <div className='flex flex-col min-h-screen font-poppins'>
        ...
        <section id='hero' className="w-full py-28 bg-[#bc3dfd]">
            <div className="container mx-auto">
                <div className="items-center flex gap-4 px-4 sm:px-6 md:px-10 md:gap-8">
                            <div className='flex flex-col w-1/2 pl-20'>
                                <RevealDownOne>
                                <div><h1 className='text-4xl pb-5 text-yellow-200'>Segarkan hidupmu dengan, <span className='font-bold'>FreshSmoothies</span></h1></div>
                                </RevealDownOne>
                                <RevealDownTwoText>
                                <div><h3 className='text-2xl  text-white'>Rasakan Nikmatnya Kesehatan di Setiap Teguknya.</h3></div>
                                </RevealDownTwoText>
                            </div>
        ...
        <section id='aboutus' className='w-full min-h-[80vh] bg-white justify-center items-center flex'>
            <div className=''>
                        <RevealDownOne>
                <div className='grid grid-flow-col max-w-[1600px] justifycenter h-auto'>
                    <div className='order-2 bg-[#80e5ff] p-6 text-[#1b7a9f] rounded-r-3xl flex items-center flex-col justify-center w-[700px]'>
                    ...
                    <img src={banner} alt='about-us' className='rounded-l-3xl w-full h-full'/>
                </div>
                        </RevealDownOne>
            </div>
        </section>
        <section id='menu' className='py-20 bg-[#ab0afc] flex flex-col box-border items-center justify-center h-screen w-full'>
           ...
           {/* Card Group */}
            <div className='flex gap-12 text-white'>
                <RevealDownOne>
                {/* Card */}
                <div className='overflow-hidden aspect-3/4  relative group card rounded-3xl'>
                    {/* Image */}
